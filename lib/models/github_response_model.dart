...
GithubResponseModel githubResponseModelFromJson(String str) => GithubResponseModel.fromJson(json.decode(str));

String githubResponseModelToJson(GithubResponseModel data) => json.encode(data.toJson());
...
class GithubResponseModel {
  ...
  factory GithubResponseModel.fromJson(Map<String, dynamic> json) => GithubResponseModel(
...
class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) => Item(
    ...
    webCommitSignoffRequired: json["web_commit_signoff_required"] == null ? null : json["web_commit_signoff_required"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "web_commit_signoff_required": webCommitSignoffRequired == null ? null : webCommitSignoffRequired,
